    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header d-flex flex-row align-items-center justify-content-between w-100">
                <h4 class="no-margins">Form Pembayaran Haji</h4>
                <button class="close" onclick="closeModal('modal_pembayaran_haji')">&times;</button> 
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-hovered table-boreded" id="table_pembayaran_haji_form">
                                <thead>
                                    <tr>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="btn_tambah_baris_ph" value="1" onclick="addRowTable('table_pembayaran_haji_form', '', this.value)"><i class="fa fa-plus"></i>&nbsp;Tambah Baris</button> |
                <button class="btn btn-primary" id="btn_simpan_ph" title="Simpan Data" onclick="doSimpanData('pembayaran_haji', this.value)">Simpan</button>
            </div>
        </div>
    </div>
</div>
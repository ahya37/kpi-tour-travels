            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="card-title py-2" style="margin: 0px;">List Table Sasaran Marketing</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped table-borderd table-hover" id="table_sasaran">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Uraian</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="prokTahunanList"><b>Detail Sasaran Kerja</b></label>
...
@push('addon-script')
    ...
    <script src="{{ asset('js/marketings/programKerja/sasaran/index.sasaran.js') }}"></script>
@endpush